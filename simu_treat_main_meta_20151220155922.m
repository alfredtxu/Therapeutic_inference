...
ref_mod = '20150917165945_ctmri_pre_20150917170318_1';
...
for we = 1 : length(weif)
    ...
    for te = 1 : length(shink_ratio)
        ...
        temp_shink = shink_ratio(te);
            ...
            for trial = 1 : times
                ...
                [b, dev, stats] = glmfit([valid_T(:) valid(:)], treat_val(:), distr, 'link', 'probit');
                ...
                [b, dev, stats] = glmfit([valid_T(:) valid(:) tsvol(:)], treat_val(:), distr, 'link', 'probit');
                ...
                [b, dev, stats] = glmfit([valid_T(:) tsvol(:)], treat_val(:), distr, 'link', 'probit');
                ...
                [b, dev, stats] = glmfit(valid_T(:), treat_val(:), distr, 'link', 'probit');
    ...
    clear beta_plain_logit dev_plain_logit stats_plain_logit
    ...
    clear beta_plain_probit dev_plain_probit stats_plain_probit
