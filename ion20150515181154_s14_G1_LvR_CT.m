...
function ion20150515181154_s14_G1_LvR_CT()
...
devia=[-12 12; -11 11; -10 10; -9 9; -8 8; -7 7; -6 6; -20 20; -18 18; -16 16; -15 15; -14 14];
    ...
    for ga=1:size(devia,1)
        ...
        for i=1:length(info_red)
            ...
            if ctgazeF==1
                ...
                if ge(abs(tgaze_min),abs(tgaze_max))
                    tgaze=tgaze_min;
                else
                    tgaze=tgaze_max;
                end
            ...
            clear ctgazeF tgaze_max tgaze_min tgaze
        end
