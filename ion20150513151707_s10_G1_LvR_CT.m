...
function ion20150513151707_s10_G1_LvR_CT()
...
% deviation: [-20 20; -18 18; -16 16; -15 15; -14 14; -12 12; -11 11]
% hit rate: 7; 8
% training ratio:0.8
% tiems: 10
% svmlin algroithm: 2
...
devia=[-20 20; -18 18; -16 16; -15 15; -14 14; -12 12; -11 11];
    ...
    for ga=1:size(devia,1)
        ...
        for i=1:length(info_red)
            ...
            if ctgazeF==1
                ...
                if le(tgaze_min,tmp_dev(1))
                    label(i,:)=1;
                elseif ge(tgaze_max,tmp_dev(2))
                    label(i,:)=-1;
                else
                    label(i,:)=9;
                end
