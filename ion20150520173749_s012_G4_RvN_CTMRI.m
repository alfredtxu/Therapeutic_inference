function ion20150520173749_s012_G4_RvN_CTMRI()
        ...
        for no=1:length(normals)
            ...
            for i=1:length(info_red)
                ...
                if ctgazeF==1 && t2gazeF==1
                    ...
                    if ge(ctgaze,tmp_dev) && gt(abs(t2gaze),tmp_nor)
                        label(i,:)=1;
                    elseif ge(ctgaze,tmp_dev) && le(abs(t2gaze),tmp_nor)
                        label(i,:)=-1;
                    else
                        label(i,:)=9;
                    end
