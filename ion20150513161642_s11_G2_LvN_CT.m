...
function ion20150513161642_s11_G2_LvN_CT()
...
% deviation: [-20 20; -18 18; -16 16; -15 15; -14 14; -12 12; -11 11; -10 10]
% normals: [-5 5; -4 4; -3 3; -2 2];
% hit rate: 7
% training ratio:0.8
% tiems: 10
% svmlin algroithm: 2
        ...
        for no=1:length(normals)
            ...
            for i=1:length(info_red)
                ...
                if ctgazeF==1
                    ...
                    tgaze_abs=max(abs(info_red(i).ctresc_clmp_calc));
                    
                    if le(tgaze_min,tmp_dev)
                        label(i,:)=1;
                    elseif le(tgaze_abs,tmp_nor)
                        label(i,:)=-1;
                    else
                        label(i,:)=9;
                    end
