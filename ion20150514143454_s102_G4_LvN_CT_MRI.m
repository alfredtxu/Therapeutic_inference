...
function ion20150514143454_s102_G4_LvN_CT_MRI()
        ...
        for no=1:length(normals)
            ...
            for i=1:length(info_red)
                ...
                if ctgazeF==1 && t2gazeF==1 
                    ...
                    ctgaze=mean(info_red(i).ctresc_clmp_calc);
                    t2gaze=mean(info_red(i).t2resc_calc);
                    
                    if le(ctgaze,tmp_dev) && lt(t2gaze,tmp_nor*-1)
                        label(i,:)=1;
                    elseif le(abs(t2gaze),tmp_nor)
                        label(i,:)=-1;
                    else
                        label(i,:)=9;
                    end
