...
function ion20150511180631_s4_G1_LvR_CT()
                    ...
                    for po=1:length(portion)
                        ...
                        for ra=1:length(tRatio)
                            ...
                            for iter=1:times
                                ...
                                sensitivity(iter,ra,po,lexitu,w,ar,ga,h)=sum(test_label==valid & test_label==1)./sum(test_label==1);
