...
mod_name = [time_stamp '_postLS_' ref_mod];
...
for we = 1 : length(weif)
    ...
    for sr = 1 : length(shink_ratio)
        ...
        temp_shink = shink_ratio(sr);
            ...
            for iter = 1 : times
                ...
                tsdatT_fn = ['tsdatT_' mod_name '_' num2str(hit) ...
                                   '_' num2str(devia) '_' num2str(norma) '_' num2str(rev) ...
                                   '_p' num2str(posnum) '_n' num2str(negnum) ...
                                   '_A' num2str(algor) '_W' num2str(wW) '_U' num2str(uU) ...
                                   '_S' num2str(sS) '_R' num2str(rR) ...
                ...
                tsdatT_fullfile = [data_path '/' mod_name '/' tsdatT_fn];
                ...
                system(['./svmlin -f ' refwei_path '/' ref_mod '/' temp_weig ...
                                   ' ' simu_folder '/' data_folder '/' mod_name '/' tsdat_fn ...
                                   ' ' simu_folder '/' data_folder '/' mod_name '/' tslab_fn]);
                ...
                system(['./svmlin -f ' refwei_path '/' ref_mod '/' temp_weig ...
                                   ' ' simu_folder '/' data_folder '/' mod_name '/' tsdatT_fn ...
                                   ' ' simu_folder '/' data_folder '/' mod_name '/' tslab_fn]);
                ...
                pv1(iter, sr)=stats.p(2);
                pv2(iter, sr)=stats.p(3);
                ...
                pv_vm1(iter, sr)=stats.p(2);
                pv_vm2(iter, sr)=stats.p(3);
                pv_vm3(iter, sr)=stats.p(4);
                ...
                pvm1(iter, sr)=stats.p(2);
                pvm2(iter, sr)=stats.p(3);
    ...
    save([pval_path '/' mod_name '/pv1_' num2str(we) '.mat'], 'pv1');
    save([pval_path '/' mod_name '/pv2_' num2str(we) '.mat'], 'pv2');
    
    save([pval_path '/' mod_name '/pv_vm1_' num2str(we) '.mat'], 'pv_vm1');
    save([pval_path '/' mod_name '/pv_vm2_' num2str(we) '.mat'], 'pv_vm2');
    save([pval_path '/' mod_name '/pv_vm3_' num2str(we) '.mat'], 'pv_vm3');
    
    save([pval_path '/' mod_name '/pvm1_' num2str(we) '.mat'], 'pvm1');
    save([pval_path '/' mod_name '/pvm2_' num2str(we) '.mat'], 'pvm2');
    
    save([pval_path '/' mod_name '/p_' num2str(we) '.mat'], 'p');

    clear pv1 pv2 pvm1 pvm2 p
    clear temp_weig
end
