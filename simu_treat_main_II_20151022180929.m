    ...
    for sr = 1 : length(shink_ratio)
        ...
        temp_shink = shink_ratio(sr);
            ...
            for iter = 1 : times
                ...
                clear temp_idx temp_treated_idx
                ...
                system(['./svmlin -f ' refwei_path '/' refmod '/' temp_weig ...
                                   ' ' pattern '/' data_folder '/' mod_name '/' tsdatT_fn ...
                                   ' ' pattern '/' data_folder '/' mod_name '/' tslab_fn]);
                
                % load the outputs and check the performance
                valid_T = sign(dlmread([tsdatT_fn '.outputs']));
                system(['mv ' tsdatT_fn '.outputs ' tsdatT_fn(1:5) 'T' tsdatT_fn(6:end) '.outputs']);
                ...
                pv1(iter, sr, we)=stats.p(2);
                pv2(iter, sr, we)=stats.p(3);
