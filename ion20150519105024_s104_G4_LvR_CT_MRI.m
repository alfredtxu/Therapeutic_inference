...
%
% Tianbo XU
% init.date: 19.05.2015
function ion20150519105024_s104_G4_LvR_CT_MRI()
...
% labelled binary zeta dataset based on left hemisphere, middle line and right hemisphere of the brain
load('zeta1333_6mm_lmr.mat');
        ...
        for no=1:length(normals)
            ...
            for i=1:length(info_red)
                ...
                if ctgazeF==1 && t2gazeF==1
                    ...
                    if le(ctgaze,tmp_dev) && le(t2gaze,tmp_dev)
                        label(i,:)=1;
