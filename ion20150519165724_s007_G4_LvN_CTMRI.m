% -- original binary imaging data;
% -- equal distribution of labelled data, parts of conversion
% -- algorithm 2;3
%
% Tianbo XU
% init.date: 19.05.2015
function ion20150519165724_s007_G4_LvN_CTMRI()
