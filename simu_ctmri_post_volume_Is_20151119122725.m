...
for te = 1 : length(treatp)
    ...
    for we = 1 : length(weif)
        ...
        for iter = 1 : times
            ...
            pv_vm1(iter, we, te)=stats.p(2);
            pv_vm2(iter, we, te)=stats.p(3);
            pv_vm3(iter, we, te)=stats.p(4);
            ...
            pvm1(iter, we, te)=stats.p(2);
            pvm2(iter, we, te)=stats.p(3);
...
save([pvalp '/' modname '/pv_vm1.mat'], 'pv_vm1');
save([pvalp '/' modname '/pv_vm2.mat'], 'pv_vm2');
save([pvalp '/' modname '/pv_vm3.mat'], 'pv_vm3');

save([pvalp '/' modname '/pvm1.mat'], 'pvm1');
save([pvalp '/' modname '/pvm2.mat'], 'pvm2');
