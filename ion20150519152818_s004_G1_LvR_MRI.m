function ion20150519152818_s004_G1_LvR_MRI()
...
devia=[-20 20; -18 18; -16 16; -15 15; -12 12; -11 11; -10 10; -8 8; -5 5];
    ...
    for ga=1:size(devia,1)
        ...
        for i=1:length(info_red)
            ...
            if t2gazeF==1
                ...
                tgaze=mean(info_red(i).t2resc_calc);
