...
function ion20150512175652_s103_G4_CT_MRI()
...
for h=1:length(hit)
    ...
    [data_red, age_red, duration_red, info_red]=ion20150430110732_reduce_dimensionality(data,age,duration,info,tmp_hit);
