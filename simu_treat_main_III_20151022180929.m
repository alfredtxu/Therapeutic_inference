...
% 
%       %       26.10.2015
%       This script is not correct, so not in USE.
    ...
    for sr = 1 : length(shink_ratio)
        ...
        temp_shink = shink_ratio(sr);
            ...
            for iter = 1 : times
                ...
                % check out the number of shinked lesion treated as recovery
                ts_neg_idx = find(tslab == -1);
                val_neg_idx = find(valid_T == -1);
                
                temp_converting = intersect(temp_treated_idx, ts_neg_idx);
                temp_converted = intersect(val_neg_idx, temp_converting);
                
                tslab_treat(temp_converted) = 1;
                ...
                clear ts_neg_idx val_neg_idx
                clear temp_converting temp_converted
