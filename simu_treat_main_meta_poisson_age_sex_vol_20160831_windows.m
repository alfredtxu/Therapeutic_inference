...
ref_mod = '201608261209_ctmri_pre_20160830174100';

% processing mode name (LS: lesion shink)
modname = [time_stamp '_postLS_' ref_mod];

% SVMLin path and pattern section name
svml_path = 'E:\a_googledrive\3.Research\3_therapeutic_inference\f1_svmlin_2015';

% sub-folders -> simulations
simu_folder = 'simulations';
        ...
        temp_shink = shink_ratio(te);
            ...
            for trial = 1 : times
                ...
                system(['/svmlin -f ' refwei_path '\' ref_mod '\' temp_weig ...
                                   ' ' svml_path '\' simu_folder '\' data_folder '\' modname '\' tsdat_fn ...
                                   ' ' svml_path '\' simu_folder '\' data_folder '\' modname '\' tslab_fn]);
                ...
                svmlin ([], ...
                              sparse([svml_path '\' simu_folder '\' data_folder '\' modname '\' tsdatT_fn]), ...
                              [svml_path '\' simu_folder '\' data_folder '\' modname '\' tslab_fn], ...
                              [refwei_path '\' ref_mod '\' temp_weig]);
                ...
                [b, dev, stats] = glmfit([valid_T(:) valid(:) tsage(:) tssex(:) tsvol(:)], treat_val(:), distr);
                ...
                [b, dev, stats] = glmfit([valid_T(:) tsage(:) tssex(:) tsvol(:)], treat_val(:), distr);
